...
static __thread aco_cofuncp_t aco_gtls_last_word_fp =
...
void aco_share_stack_init(aco_share_stack_t* p, void* stack, size_t sz) {
  ...
  p->valgrind_stk_id =
      VALGRIND_STACK_REGISTER(p->ptr, (void*)((uintptr_t)p->ptr + p->sz));
#endif
...
#ifdef __i386__
    // POSIX.1-2008 (IEEE Std 1003.1-2008) - General Information - Data Types -
    // Pointer Types

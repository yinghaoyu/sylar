...
extern void aco_save_fpucw_mxcsr(void* p) __asm__(
    "aco_save_fpucw_mxcsr");  // asm

extern void aco_funcp_protector_asm(void) __asm__(
    "aco_funcp_protector_asm");  // asm

extern void aco_funcp_protector(void);

extern aco_share_stack_t* aco_share_stack_new(size_t sz);

extern void aco_share_stack_init(aco_share_stack_t* ass, void* stack,
                                 size_t sz);
...
extern aco_t* aco_create(aco_t* main_co, aco_share_stack_t* share_stack,

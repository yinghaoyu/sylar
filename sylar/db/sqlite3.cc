...
int SQLite3::getErrorCode() const { return sqlite3_errcode(m_db); }

std::string SQLite3::getErrorMsg() const { return sqlite3_errmsg(m_db); }
...
bool SQLite3Data::next() { return m_stmt->step() == SQLITE_ROW; }
